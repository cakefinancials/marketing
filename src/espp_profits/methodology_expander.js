...
export class MethodologyExpander extends Component {
  constructor(props) {
    super(props);
  ...
  renderMethodology() {
    return (
      <Row className='methodology-card-container'>
        <Col className='text-container' span={12} offset={6}>
          <p>
          ...
          <p>
            ...
            percentage (P) by the total discount (D) and then dividing the profits by 2 to represent the subtraction of
            Cake’s share of the profits. Where D = (dE: max ESPP discount) + (dL: discount from lookback, explained
            below).
          </p>
          <p>This calculation looks like: (I*P*(dE+dL)/2.</p>
          <p>
            If your ESPP program has a lookback provision it makes this calculation much more interesting, as you get to
            buy the stock at a discount below the LOWEST price between the stock price at the beginning of the purchase
            period and the last day. Let’s say your stock went up 10% in a purchase period, this means that you are
            effectively buying it at a discount of 25% (10% for lookback +15% for discount)
          </p>
          <p>
          ...
          <p>
            ...
            place. However, you can always use this tool as a way to convince your finance department that this would be
