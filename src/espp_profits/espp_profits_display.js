...
export const ESPPProfitsDisplay = stateManagerContainer.withStateManagers({
  ...
  WrappedComponent: withRouter(
    class ESPPProfitsDisplay extends Component {
      constructor(props) {
        super(props);

        this.companyInfo = this.props.stateManagers[STATE_MANAGER_NAMES.COMPANY_INFO];
        this.esppProfitsModelInputsStateManager = this.props.stateManagers[
          STATE_MANAGER_NAMES.ESPP_PROFITS_MODEL_INPUTS
        ];
      ...
      async componentWillMount() {
        ...
        if (!esppProfitsModel || esppProfitsModel.company === undefined) {
          this.props.history.push('/espp');
        } else {
                ...
                <Fragment>
                  ...
                  <Row>
                    <div className="flights-and-coffee-container">
                      <p>
                        That is enough to buy {roundTripFlights} round-trip flights from Dallas, TX to Reykjavik,
                        Iceland and {cupsOfJoe} cups of coffee to enjoy as you plan those well-deserved vacations.
                      </p>
                    </div>
                  </Row>
                </Fragment>
          ...
          <div className="espp-profits-display-container">
            <Spin spinning={loadingStockData}>
              ...
              <Row className="period-returns-summary-container">
                <Col
                  className="summary-card-container-column"
                  sm={{ span: 20, offset: 2 }}
                  lg={{ span: 16, offset: 4 }}
                >
                  {R.addIndex(R.map)(
